...
<div class="p-4 md:p-8"> <!-- Added padding for better spacing on small screens -->
    <form wire:submit.prevent="submit" class="space-y-4"> <!-- Prevent default form submission -->
        ...
        <div class="pt-4 md:pt-6"> <!-- Adjusted vertical spacing -->
            <x-button type="submit" primary right-icon="calendar" spinner>Schedule Note</x-button>
        </div>
        <x-errors /> <!-- Moved error messages outside the form for better placement -->
    </form>
</div>
